    ...
    public List<FileFragment> getAllFiles() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                fileFragment.setFileFragmentNameOne(cursor.getString(cursor.getColumnIndex(FileFragment.COLUMN_FileFragments_Origin)));
                fileFragment.setFileFragmentNameTwo(cursor.getString(cursor.getColumnIndex(FileFragment.COLUMN_FileFragments_Origin)));
                fileFragment.setFileFragmentNameThree(cursor.getString(cursor.getColumnIndex(FileFragment.COLUMN_FileFragments_Origin)));
